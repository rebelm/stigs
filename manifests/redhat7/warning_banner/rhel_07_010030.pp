...
class stigs::redhat7::warning_banner::rhel_07_010030 inherits stigs::redhat7::redhat7 {
  ...
  # Include banner-message-text if stig 010031 is set to present
  if $rhel_07_010031 == 'present' {
    $banner_settings = @(EOF)
      [org/gnome/login-screen]
      banner-message-enable=true
      banner-message-text='You are accessing a U.S. Government (USG) Information System (IS) that is
